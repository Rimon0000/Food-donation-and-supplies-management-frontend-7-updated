            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                <div className="shadow-xl rounded-2xl">
                    ...
                    <div className="p-8">
                        ...
                        <h1 className="mt-5 font-semibold text-xl">Hope Harvest: Feeding Dreams for Underprivileged peoples.</h1>
                        <p className="my-5 text-justify">"Feed the Future: Join us in providing nourishment and hope to street children. Your donation can make a real difference in their lives, offering them a brighter tomorrow."</p>
